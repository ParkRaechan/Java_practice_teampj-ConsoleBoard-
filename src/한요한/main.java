...
public class main {
	...
	public static void 카테고리보기(String id, int 카테고리선택) {
		...
		}else if(행동선택 == 4) { // 이전페이지 // 보물찾기 임시테스트
/////////////////////////////////////////////////////////////////////
			//1.게임판 초기화
			while(true) { // 프로그램실행
				int 게임판인덱스 = 0; 
				...
				System.out.println("1.뽑기 2.뒤로가기"); int ch = scanner.nextInt(); // 선택입력받기
				if(ch == 1) {// 뽑기 시작
